...
\item A menos que se indique lo contrario cada problema define diferentes
  subtareas que restringen el problema y se asignará puntaje de acuerdo a la
  cantidad de subtareas que logre solucionar de manera correcta.
\item A menos que se indique lo contrario para obtener el puntaje en una
  subtarea se debe tener todos los casos de prueba en este correctos.
